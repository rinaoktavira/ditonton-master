...
import 'top_rated_televisi_page_test.mocks.dart';

@GenerateMocks([TopRatedTelevisiNotifier])
void main() {
  late MockTopRatedTelevisiNotifier mockNotifier;

  setUp(() {
    mockNotifier = MockTopRatedTelevisiNotifier();
  });

  Widget _makeTestableWidget(Widget body) {
    return ChangeNotifierProvider<TopRatedTelevisiNotifier>.value(
      value: mockNotifier,
      child: MaterialApp(
        home: body,
      ),
  ...
  testWidgets('Page should display progress bar when loading',
        ...
        await tester.pumpWidget(_makeTestableWidget(TopRatedTelevisiPage()));
